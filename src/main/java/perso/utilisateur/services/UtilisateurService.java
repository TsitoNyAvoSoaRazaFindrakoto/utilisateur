...
public class UtilisateurService {
    ...
    public UtilisateurService(TokenService tokenService, UtilisateurRepo utilisateurRepo,
            TentativeConnectionService tentativeConnectionService, RoleService roleService, MailService mailService) {
    ...
    public ResponseJSON loginPin(String pin, String tokenUtilisateur) {
        ...
        try {
            utilisateur = this.utilisateurRepo.findUtilisateurByToken(tokenUtilisateur)
